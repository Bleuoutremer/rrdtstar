...
class Env:
    ...
    def pygame_init(self, enable_pygame=True):
        ...
        self.myfont = pygame.font.SysFont('Arial',
                                          int(self.XDIM * 0.03 * self.args.scaling))
        ################################################################################
        # main window
...
###################################################################################
        ...
        if count % 10 == 0:
            ...
            if type(self.args.sampler).__name__ in ['RRdTSampler','RRdTInformedSampler'] and count > 0:
                num_nodes = sum(
            ...
            text = 'Cost: {} | Inv.Samples: {}(con) {}(obs) |Nodes: {} | Time: {}'.format(
